...
public class ObjectFactory {
    ...
    private final static QName _Convert_QNAME = new QName("http://JAXWS/", "Convert");
    private final static QName _ConvertResponse_QNAME = new QName("http://JAXWS/", "ConvertResponse");
    private final static QName _ListeComptes_QNAME = new QName("http://JAXWS/", "ListeComptes");
    private final static QName _ListeComptesResponse_QNAME = new QName("http://JAXWS/", "ListeComptesResponse");
    private final static QName _Compte_QNAME = new QName("http://JAXWS/", "compte");
    private final static QName _GetCompte_QNAME = new QName("http://JAXWS/", "getCompte");
    private final static QName _GetCompteResponse_QNAME = new QName("http://JAXWS/", "getCompteResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://JAXWS/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://JAXWS/", name = "ConvertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://JAXWS/", name = "ListeComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://JAXWS/", name = "ListeComptesResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://JAXWS/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://JAXWS/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://JAXWS/", name = "getCompteResponse")
